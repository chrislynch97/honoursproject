...
final class Constants {
  ...
  static final double WEIGHT_W = 1.0;
  static final double WEIGHT_M = 1.0;

  static final double INITIAL_FEEDING_FIELD = 0.0;
  static final double INITIAL_LINKING_FIELD = 0.0;
